...
# Load the API keys from Streamlit secrets
groq_api_key = st.secrets["GROQ_API_KEY"]
google_api_key = st.secrets["GOOGLE_API_KEY"]

# Set the GOOGLE_API_KEY environment variable (if needed by the package)
...
def vector_embedding():
    if "vectors" not in st.session_state:
        ...
        st.session_state.loader = PyPDFDirectoryLoader("./laws")  # Data Ingestion
...
processed_files = set(get_pdf_files('./laws'))

# Load previously processed files to check for new additions
